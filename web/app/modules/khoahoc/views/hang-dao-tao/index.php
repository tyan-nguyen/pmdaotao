...
/* @var $searchModel app\modules\khoahoc\models\search\HangDaoTaoSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Hang Dao Taos';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="hang-dao-tao-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Tambah Hang Dao Taos','class'=>'btn btn-default']).
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="fas fa fa-list" aria-hidden="true"></i> Hang Dao Taos listing',
