...
?>
<?php foreach ($fileHocVien as $fileHV){ ?>
    ...
    <div class="card custom-card">
        <div class="card-body p-3">
            <div class="d-flex">
                <span class="bg-primary-transparent border border-primary br-3 pd-5">
                    <?= Html::img($fileHV ? File::getIcon($fileHV->file_type) : '', ['width'=>50]) ?>
                </span>
                <div class="ms-auto mt-1 file-dropdown">
                    ...
                    echo Html::a('<i class="fe fe-edit me-2 float-start"></i>Sửa', 
                            ['/kholuutru/file/update', 'id'=>$fileHV->id],
                            [
        ...
        <div class="card-footer border-top-0">
            <div class="d-flex "id="fileContent3">
                <div>
                    <h5 class="text-primary"><?= $fileHV->file_display_name ?></h5>
                    <p class="text-muted fs-13 mb-0"><?= $fileHV->file_name ?></p>
                </div>
                <div class="ms-auto">
                    <h6 class="fs-11 text-muted"><?= $fileHV->file_size ?></h6>
                    <h6 class="fs-11 text-muted"><?= $fileHV->id ?></h6>
                </div>
            </div>
        </div>
    </div>
