...
/* @var $searchModel app\models\HocVienSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Hv Hoc Viens';
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

?>
<div class="hv-hoc-vien-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Tambah Hv Hoc Viens','class'=>'btn btn-default']).
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="fas fa fa-list" aria-hidden="true"></i> Hv Hoc Viens listing',
