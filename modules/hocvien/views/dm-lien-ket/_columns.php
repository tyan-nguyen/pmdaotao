...
return [
    ...
    [
        'class'=>'\kartik\grid\DataColumn',
        'attribute'=>'loai_lien_ket',
        'value'=>function($model){
            return $model->getDmLoaiLienKetLabel($model->loai_lien_ket);
        },
        'width' => '150px',
    ],
    [
        'class'=>'\kartik\grid\DataColumn',
        'attribute'=>'ten_lien_ket',
        'width' => '300px',
    ],
    [
        'class'=>'\kartik\grid\DataColumn',
        'label'=>'Số lượng HV',
        'value'=>function($model){
            return DangKyHv::find()->where(['id_lien_ket'=>$model->id])->count();
        },
        'width' => '100px',
    ],
    [
