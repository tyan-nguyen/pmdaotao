...
?>
<?php if(Yii::$app->params['showSearch']):?><div class="card border-default" id="divFilterExtend" <?= Yii::$app->request->get('DangKyHvSearch') ? 'style="display:block;"' : 'style="display:none;"' ?>>
    ...
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'panel' => [
                ...
                'heading' => '<i class="typcn typcn-folder-open"></i> DANH SÁCH LIÊN KẾT',
                'before'=>false,
            ],
            'export'=>[
                'options' => [
