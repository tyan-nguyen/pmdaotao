...
?>
<?php
$model->ngay_thi_cu = CustomFunc::convertYMDToDMY($model->ngay_thi_cu);
$model->ngay_thi_moi = CustomFunc::convertYMDToDMY($model->ngay_thi_moi);
?>
<div class="hv-hoc-vien-form">
    ...
    <?php CardWidget::begin(['title'=>'Thông tin yêu cầu đổi ngày sát hạch']) ?>
    <div class ='row'>
    	<div class="col-md-3">
        	<?= $form->field($model, 'ngay_thi_cu')->widget(DatePicker::classname(), [
        ...
        <div class="col-lg-12 col-md-12">
            <?= $form->field($model, 'ly_do_doi_lich')->textarea(['rows' => 3, 'style'=>'width:100%']) ?>
        </div> 
        <div class="col-lg-3 col-md-3">
            <?= $form->field($model, 'da_xu_ly')->checkbox() ?>
        </div> 
        <div class="col-md-9">
        	<?= $form->field($model, 'ngay_thi_moi')->widget(DatePicker::classname(), [
                'options' => ['placeholder' => 'Chọn ngày ...'],
                'pluginOptions' => [
                    'autoclose' => true,
                    'format' => 'dd/mm/yyyy',
