...
/* @var $searchModel app\modules\hocvien\models\search\DmLienKetSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Danh mục nhận hồ sơ';
...
?>
<?php if(Yii::$app->params['showSearch']):?><div class="card border-default" id="divFilterExtend" <?= Yii::$app->request->get('DmNhanHoSoHoSearch') ? 'style="display:block;"' : 'style="display:none;"' ?>>
    ...
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'panel' => [
                ...
                'heading' => '<i class="typcn typcn-folder-open"></i> DANH SÁCH NHẬN HỒ SƠ',
                'before'=>false,
            ],
            'export'=>[
                'options' => [
