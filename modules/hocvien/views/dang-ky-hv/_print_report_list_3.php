	...
	<div class="col-md-12" style="width: 100%">
		...
		<table id="table-tieu-de-1" style="width: 100%">
			<tr>
				...
				<td>
					...
					<!-- <br /><span>Nhân viên nhận hồ sơ: <?= $byuser > 0 ? User::findOne($byuser)->getHoTen() : 'Tất cả' ?></span> -->
					<br /><span>Nhân viên nhận hồ sơ:
						<?php
						if ($byuser > 0) {
							echo User::findOne($byuser)->getHoTen();
						} else if ($byreceivemoney) {
							echo isset(DangKyHv::getDmNoiDangKyShort()[$byreceivemoney]) ? DangKyHv::getDmNoiDangKyShort()[$byreceivemoney] : '';
						} else {
							echo 'Tất cả';
						}
						?>
		...
		<table class="table-content" style="width: 100%; margin-top:5px;">
			...
			<tbody>
				...
				?>
					<tr>
						<td colspan="17" style="text-align:center">Không có</td>
					</tr>
					<?php
				} else {
					...
					?>
						<tr>
							...
							<td style="text-align:left"><?= $item->hocVien->khoaHoc ? $item->hocVien->khoaHoc->ten_khoa_hoc : '' ?></td>
