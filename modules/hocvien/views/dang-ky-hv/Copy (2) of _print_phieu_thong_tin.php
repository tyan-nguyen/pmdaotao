    ...
    <div class="col-md-12" style="width: 100%"> 
    	...
    	<table id="table-tieu-de" style="width: 100%">
    		<tr>
    			...
    			<td>Số: <?= ($nhap && $model->ma_so_phieu==null) ? '' : CustomFunc::fillNumber($model->getMaSoPhieu()) ?></td>
    		</tr>
    	</table>
    	
    	<table id="table-noi-dung" style="width: 100%">
    		<tr>
    			<td>Họ tên học viên: <?= $model->ho_ten ?></td>
    			<td>Mã KH: <?= CustomFunc::fillNumber($model->id) ?></td>
    		</tr>
    		<tr>
    			<td>Địa chỉ: <?= $model->dia_chi ?></td>
    			<td>SDT: <?= $model->so_dien_thoai ?></td>
    		</tr>
    		<tr>
    			<td colspan="2">Nội dung: Thu <?= $phanTram ?> học phí đăng ký học <?= $model->hangDaoTao ? $model->hangDaoTao->ten_hang : '-' ?></td>
    		</tr>
    		<tr>
    			<td colspan="2">Số tiền: <?= $tuyChonIn!=3 ? number_format($soTienDong, 0, ',', '.') : '.................' ?> đồng</td>
    		</tr>
    		<tr>
    			<td colspan="2">Còn lại: <?= $tuyChonIn!=3 ? number_format($soTienConLai, 0, ',', '.'):'.................' ?> đồng</td>
    		</tr>
    		<tr>
