...
$model->ngay_nhan_tai_lieu = $model->ngay_nhan_tai_lieu
    ? CustomFunc::convertYMDToDMY($model->ngay_nhan_tai_lieu)
    : date('d/m/Y');
...
<div class="alert alert-outline-success" role="alert">
	...
	<strong><span class="alert-inner--icon d-inline-block me-1"><i class="fe fe-bell"></i></span> Giao tài liệu cho học viên</strong> 
	<ul>
		<li><i class="fa fa-angle-double-right mb-2 me-2"></i> Chọn đã nhận tài liệu</li>
		<li><i class="fa fa-angle-double-right mb-2 me-2"></i> Chọn ngày nhận</li>
	</ul>
</div>

<?= !$isAdmin?'':$this->render('nhan-tai-lieu_view', ['model'=>DangKyHv::findOne($model->id)])  ?>
...
<div class="hv-hoc-vien-form">
    ...
    <?php CardWidget::begin(['title'=>'Thông tin nhận tài liệu']) ?>
    <div class ='row'>
        ...
        <div class="col-lg-3 col-md-6">
           ...
           ?>           
           <?= !$isAdmin?'':$form->field($model, 'nguoi_giao_tai_lieu')->widget(Select2::classname(), [
