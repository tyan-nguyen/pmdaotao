...
$listTitle = 'Danh sách học viên hủy hồ sơ';
	...
	<div class="card-body">
		<div class="expanel expanel-default">
			<div class="expanel-body">
				<?php 
                    echo $this->render("_search_huy_ho_so", ["model" => $searchModel]);
                ?>
			</div>
		</div>
	</div>
...
<div class="van-ban-den-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'columns' => require(__DIR__.'/_columns_huy_ho_so.php'),
            ...
            'panel' => [
                ...
                'heading' => '<i class="typcn typcn-folder-open"></i> DANH SÁCH HỌC VIÊN HỦY HỒ SƠ',
                'before'=>false,
            ],
            'export'=>[
                'fontAwesome' => true,
