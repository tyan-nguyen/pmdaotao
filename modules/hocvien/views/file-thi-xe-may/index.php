...
$this->title = 'File danh sách thi xe máy';
    ...
    <div id="ajaxCrudDatatable">
        <?= GridView::widget([
                ...
                [
                    ...
                    <div class="dropdown">
                        ...
                        Html::a(
                            ...
                            ['/hocvien/file-thi-xe-may/import?menu=hvd'],
            ...
            'panel' => [
                ...
                'heading' => '<i class="typcn typcn-folder-open"></i> DANH SÁCH FILE DS THI XE MÁY',
                'before' => false,
            ],
            'export' => [
                'options' => [
