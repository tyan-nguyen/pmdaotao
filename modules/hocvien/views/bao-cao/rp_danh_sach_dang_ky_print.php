        ...
        <table id="table-top" style="width: 100%">
        	<tr>
        		...
        		<td>
        			...
        			<br/>
        			<span style="font-size:10pt"><i class="fas fa-map-marker-alt" style="color:red;margin-right:2px"></i>  Địa chỉ đăng ký: Nguyễn Đáng, Khóm 20, Phường Trà Vinh, Tỉnh Vĩnh Long</span>
        			<br/>
        			<span style="font-size:10pt"><i class="fas fa-home" style="color:red"></i> Địa chỉ TT: Ấp Giồng Trôm, Xã Châu Thành, Vĩnh Long</span>
        			<br/>
