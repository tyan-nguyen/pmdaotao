...
<div class="nop-hoc-phi-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'columns' => require(__DIR__.'/_columns-phieu-thu-thue.php'),
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    . Html::a('<i class="fas fa-clipboard-list"></i> In DS theo ca', ['/hocvien/dang-ky-hv/report-list'],
 ...
 */
            ...
            'panel' => [
                ...
                'heading' => '<i class="typcn typcn-folder-open"></i> DANH SÁCH PHIẾU THU',
                'before'=>false,
            ],
            'export'=>[
                'fontAwesome' => true,
                ...
                'filename' => 'ds_phieu_thu_' . date('Y-m-d'), // tên file export mặc định
                'options' => [
                    'class' => 'btn'
                ]
            ],
            'exportConfig' => [
                GridView::EXCEL => [
                    'label' => 'Xuất Excel',
                    'filename' => 'ds_phieu_thu_' . date('Y-m-d'),
                    'options' => ['title' => 'Danh sách phiếu thu'],
                    'config' => [
                        'worksheet' => 'Danh sách',
                        'cssFile' => '', // nếu cần
                    ],
                ...
                GridView::PDF => [
                    ...
                    'config' => [
                        'methods' => [
                            'SetHeader' => ['DANH SÁCH PHIẾU THU|DANH SÁCH|Xuất ngày: ' . date("d/m/Y")],
