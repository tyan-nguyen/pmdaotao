...
$listTitle = 'Thống kê hàng hóa (áo, tài liệu)';
...
if (!empty($searchModel->ngay_nhan_tai_lieu_tu)) {
    $searchModel->ngay_nhan_tai_lieu_tu = CustomFunc::convertYMDToDMY($searchModel->ngay_nhan_tai_lieu_tu);
}
if (!empty($searchModel->ngay_nhan_tai_lieu_den)) {
    $searchModel->ngay_nhan_tai_lieu_den = CustomFunc::convertYMDToDMY($searchModel->ngay_nhan_tai_lieu_den);
}
if (!empty($searchModel->ngay_nhan_ao_tu)) {
    $searchModel->ngay_nhan_ao_tu = CustomFunc::convertYMDToDMY($searchModel->ngay_nhan_ao_tu);
}
if (!empty($searchModel->ngay_nhan_ao_den)) {
    $searchModel->ngay_nhan_ao_den = CustomFunc::convertYMDToDMY($searchModel->ngay_nhan_ao_den);
}
    ...
    <div class="card-body">
        <div class="expanel expanel-default">
            <div class="expanel-body">
                <?php
                echo $this->render("hang-tang/_search", ["model" => $searchModel]);
                ?>
            </div>
        </div>
    </div>
...
<div class="van-ban-den-index">
    <div id="ajaxCrudDatatable">
        ...
        <?php if (
            !empty($searchModel->id_khoa_hoc) || !empty($searchModel->noi_dang_ky)
            || !empty($searchModel->id_hangs)
            || !empty($searchModel->ngay_dang_ky_tu) || !empty($searchModel->ngay_dang_ky_den)
            || !empty($searchModel->nguoi_tao)
            || !empty($searchModel->da_nhan_tai_lieu)
            || !empty($searchModel->ngay_nhan_tai_lieu_tu) || !empty($searchModel->ngay_nhan_tai_lieu_den)
            || !empty($searchModel->nguoi_giao_tai_lieu)
            || !empty($searchModel->noi_giao_tai_lieu)
            || !empty($searchModel->da_nhan_ao)
            || !empty($searchModel->ngay_nhan_ao_tu) || !empty($searchModel->ngay_nhan_ao_den)
            || !empty($searchModel->nguoi_giao_ao)
            || !empty($searchModel->noi_giao_ao)
                    ...
                    <div>
                        ...
                        <ul>
                            ...
                            <?php if ($searchModel->ngay_dang_ky_tu): ?>
                                <li><i class="fa fa-angle-double-right mb-2 me-2"></i> <strong>Nhận hồ sơ từ:</strong> <?= $searchModel->ngay_dang_ky_tu ?></li>
                            <?php endif; ?>
                            <?php if ($searchModel->ngay_dang_ky_den): ?>
                                <li><i class="fa fa-angle-double-right mb-2 me-2"></i> <strong>Nhận hồ sơ đến:</strong> <?= $searchModel->ngay_dang_ky_den ?></li>
                            <?php endif; ?>
                            <?php if ($searchModel->nguoi_tao): ?>
                                <li><i class="fa fa-angle-double-right mb-2 me-2"></i> <strong>Người tạo:</strong>
                                    <?php
                                    $user = User::findOne($searchModel->nguoi_tao);
                                    echo $user ? $user->shortName : '';
                                    ?>
                                </li>
                            <?php endif; ?>
                            <?php if ($searchModel->da_nhan_tai_lieu): ?>
                                <li><i class="fa fa-angle-double-right mb-2 me-2"></i> <strong>Nhận tài liệu:</strong> <?= $searchModel->da_nhan_tai_lieu ? 'Đã nhận tài liệu' : '' ?></li>
                            <?php endif; ?>
                            <?php if ($searchModel->ngay_nhan_tai_lieu_tu): ?>
                                <li><i class="fa fa-angle-double-right mb-2 me-2"></i> <strong>Nhận tài liệu từ:</strong> <?= $searchModel->ngay_nhan_tai_lieu_tu ?></li>
                            <?php endif; ?>
                            <?php if ($searchModel->ngay_nhan_tai_lieu_den): ?>
                                <li><i class="fa fa-angle-double-right mb-2 me-2"></i> <strong>Nhận tài liệu đến:</strong> <?= $searchModel->ngay_nhan_tai_lieu_den ?></li>
                            <?php endif; ?>
                            <?php if ($searchModel->nguoi_giao_tai_lieu): ?>
                                <li><i class="fa fa-angle-double-right mb-2 me-2"></i> <strong>Người giao tài liệu:</strong>
                                    <?php
                                    $user = User::findOne($searchModel->nguoi_giao_tai_lieu);
                                    echo $user ? $user->shortName : '';
                                    ?>
                                </li>
                            <?php endif; ?>
                            <?php if ($searchModel->noiNhanTaiLieu): ?>
                                <li><i class="fa fa-angle-double-right mb-2 me-2"></i> <strong>Nơi giao tài liệu:</strong>
                                    <?php
                                    //$user = User::findOne($searchModel->noiNhanTaiLieu);
                                    ?>
                                    <?= $searchModel->noiNhanTaiLieu ? DangKyHv::getDmNoiDangKyShort()[$searchModel->noiNhanTaiLieu] : '' ?></li>
                            <?php endif; ?>


                            <?php if ($searchModel->da_nhan_ao): ?>
                                <li><i class="fa fa-angle-double-right mb-2 me-2"></i> <strong>Nhận áo:</strong> <?= $searchModel->da_nhan_ao ? 'Đã nhận áo' : '' ?></li>
                            <?php endif; ?>
                            <?php if ($searchModel->ngay_nhan_ao_tu): ?>
                                <li><i class="fa fa-angle-double-right mb-2 me-2"></i> <strong>Nhận áo từ:</strong> <?= $searchModel->ngay_nhan_ao_tu ?></li>
                            <?php endif; ?>
                            <?php if ($searchModel->ngay_nhan_ao_den): ?>
                                <li><i class="fa fa-angle-double-right mb-2 me-2"></i> <strong>Nhận áo đến:</strong> <?= $searchModel->ngay_nhan_ao_den ?></li>
                            <?php endif; ?>
                            <?php if ($searchModel->nguoi_giao_ao): ?>
                                <li><i class="fa fa-angle-double-right mb-2 me-2"></i> <strong>Người giao áo:</strong>
                                    <?php
                                    $user = User::findOne($searchModel->nguoi_giao_ao);
                                    echo $user ? $user->shortName : '';
                                    ?>
                                </li>
                            <?php endif; ?>
                            <?php if ($searchModel->noiNhanAo): ?>
                                <li><i class="fa fa-angle-double-right mb-2 me-2"></i> <strong>Nơi giao áo:</strong>
                                    <?php
                                    //$user = User::findOne($searchModel->noiNhanTaiLieu);
                                    ?>
                                    <?= $searchModel->noiNhanAo ? DangKyHv::getDmNoiDangKyShort()[$searchModel->noiNhanAo] : '' ?></li>
                            <?php endif; ?>
                            <?php if ($searchModel->size): ?>
                                <li><i class="fa fa-angle-double-right mb-2 me-2"></i> <strong>Size:</strong> <?= $searchModel->size ?></li>
                            <?php endif; ?>
        ...
        <?= GridView::widget([
            ...
            'columns' => require(__DIR__ . '/hang-tang/_columns.php'),
