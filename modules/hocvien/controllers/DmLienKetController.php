...
use app\modules\hocvien\models\search\DmLienKetSearch;
...
/**
 * DmLienKetController implements the CRUD actions for DmLienKet model.
 */
class DmLienKetController extends Controller
{
    /**
     * @inheritdoc
     */
     ...
     */
    public function actionSearchDmLienKet($q = null)
    {
    ...
    /**
     * Displays a single DmLienKet model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing DmLienKet model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing DmLienKet model.
     * For ajax request will return json object
    ...
    /**
     * Finds the DmLienKet model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return DmLienKet the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = DmLienKet::findOne($id)) !== null) {
            return $model;
        } else {
