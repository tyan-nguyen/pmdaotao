 ...
 */
class HocVienFromKhoaHocController extends Controller
{
    /**
     * @inheritdoc
     */
     ...
     * @return mixed
     */
    public function actionView($id,$modalType='modal-remote')
    {   
        ...
        if($request->isAjax){
            ...
            return [
                ...
                ($modalType=='modal-remote'?Html::a('Sửa',['update','id'=>$id],['class'=>'btn btn-primary','role'=>$modalType]):'')
                ];    
        }else{
     ...
     * @return mixed
     */
    public function actionUpdateFromKhoaHoc($id,$modalType='modal-remote',$idKhoaHoc)
    {
        $request = Yii::$app->request;
        $model = $this->findModel($id);   
        $khoHocModel  = KhoaHoc::findOne($idKhoaHoc);
        if(!$khoHocModel){
            return [
                'title'=> "Thông báo",
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    'reloadType'=>'hocVien',
                    'reloadBlock'=>'#listHv',
                    'reloadContent'=>$this->renderAjax('@app/modules/khoahoc/views/khoa-hoc/xem_hv', ['model' => $khoHocModel]),
                    'forceClose'=>true,
                ];
