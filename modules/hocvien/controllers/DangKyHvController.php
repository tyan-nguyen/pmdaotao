...
class DangKyHvController extends Controller
{
    ...
    public function actionView($id)
    {
        ...
        if ($request->isAjax) {
            ...
            return [
                'title' => "Học viên  #" . $id,
                'content' => $this->renderAjax($viewModel, [
            ...
            if ($request->isGet) {
                if (!$model->da_nhan_tai_lieu || User::getCurrentUser()->superadmin)
                    return [
                        ...
                        'footer' => Html::button('Đóng lại', ['class' => 'btn btn-default pull-left', 'data-bs-dismiss' => "modal"]) .
                            Html::button('Lưu lại', ['class' => 'btn btn-primary', 'type' => "submit"]) .
                            ($user->superadmin ? Html::a('<i class="fas fa-trash-alt"></i> Xóa nhận tài liệu', ['dang-ky-hv/xoa-nhan-tai-lieu', 'idhv' => $idhv], [
                    ...
                    return [
                        ...
                        'footer' => Html::button('Đóng lại', ['class' => 'btn btn-default pull-left', 'data-bs-dismiss' => "modal"]) .
                            ($allowDel ? Html::a('<i class="fas fa-trash-alt"></i> Xóa nhận tài liệu', ['dang-ky-hv/xoa-nhan-tai-lieu', 'idhv' => $idhv], [
                                'class' => 'btn btn-warning',
                                'role' => 'modal-remote',
                                'data-confirm-title' => 'Xác nhận xóa thông tin nhận tài liệu?',
                                'data-confirm-message' => 'Bạn có chắc muốn xóa?'
            ...
            if ($request->isGet) {
                if (!$model->da_nhan_ao || User::getCurrentUser()->superadmin)
                    return [
                        ...
                        'footer' => Html::button('Đóng lại', ['class' => 'btn btn-default pull-left', 'data-bs-dismiss' => "modal"]) .
                            Html::button('Lưu lại', ['class' => 'btn btn-primary', 'type' => "submit"]) .
                            ($user->superadmin ? Html::a('<i class="fas fa-trash-alt"></i> Xóa nhận áo', ['dang-ky-hv/xoa-nhan-ao', 'idhv' => $idhv], [
                                'class' => 'btn btn-warning',
                                'role' => 'modal-remote',
                    ...
                    return [
                        ...
                        'footer' => Html::button('Đóng lại', ['class' => 'btn btn-default pull-left', 'data-bs-dismiss' => "modal"]) .
                            ($allowDel ? Html::a('<i class="fas fa-trash-alt"></i> Xóa nhận áo', ['dang-ky-hv/xoa-nhan-ao', 'idhv' => $idhv], [
                                'class' => 'btn btn-warning',
                                'role' => 'modal-remote',
                                'data-confirm-title' => 'Xác nhận xóa thông tin nhận áo?',
                                'data-confirm-message' => 'Bạn có chắc muốn xóa?'
