...
use cangak\ajaxcrud\BulkButtondWidget;
use yii\widgets\Pjax;

/* @var $this yii\web\View */
/* @var $searchModel app\modules\hanghoa\models\search\LoaiHangHoaSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Loại hàng hóa';
    ...
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'panel' => [
                ...
                'heading' => '<i class="typcn typcn-folder-open"></i> DANH SÁCH LOẠI HÀNG HÓA',
                'before'=>false,
            ],
            'export'=>[
                'fontAwesome' => true,
                ...
                'filename' => 'ds_loai_hang_hoa_' . date('Y-m-d'), // tên file export mặc định
                'options' => [
                    'class' => 'btn'
                ]
            ] ,
            'exportConfig' => [
                GridView::EXCEL => [
                    ...
                    'options' => ['title' => 'Danh sách loại hàng hóa'],
                    'config' => [
                        'worksheet' => 'Hàng hóa',
                        'cssFile' => '', // nếu cần
                    ],
                ...
                GridView::PDF => [
                    ...
                    'config' => [
                        'methods' => [
                            'SetHeader' => ['DANH SÁCH LOẠI HÀNG HÓA|DANH SÁCH|Xuất ngày: ' . date("d/m/Y")],
