...
function InBaoCao(typereport) {
    $.ajax({
        type: 'POST',
        url: $('#bienbanfull').val()==1 ? '/banhang/report/rp-theo-ca-hang-hoa-print?startdate=' + $('#startdate').val() + '&starttime=' + $('#starttime').val() + '&enddate=' + $('#enddate').val() + '&endtime=' + $('#endtime').val() + '&byuser='+ $('#byuser').val() + '&sortby='+ $('#sort').val() + '&bienbanfull=' + $('#bienbanfull').val() : '/banhang/report/rp-theo-ca-hoa-don-print?startdate=' + $('#startdate').val() + '&starttime=' + $('#starttime').val() + '&enddate=' + $('#enddate').val() + '&endtime=' + $('#endtime').val() + '&byuser='+ $('#byuser').val() + '&sortby='+ $('#sort').val() + '&bienbanfull=' + $('#bienbanfull').val(),
