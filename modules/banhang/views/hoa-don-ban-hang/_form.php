...
<script type="text/javascript">
    ...
    function AddVatTu() {
        ...
        formRow += '<td><input type="number" name="soLuong" id="soLuongNew" class="form-control" step="any" required style="width:80px"/></td>';
    ...
    function editVatTu(arr) {
        if ($("#idTrUpdate").length > 0) {
            ...
            formRow += '<td>' + arr['tenLoaiHangHoa'] + '</td>';
            formRow += '<td>' + arr['tenHangHoa'] + '</td>';
