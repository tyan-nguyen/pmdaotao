...
?>
<?php foreach ($fileNhanVien as $fileNV){ ?>
    ...
    <div class="card custom-card">
        <div class="card-body p-3">
            <div class="d-flex">
                <span class="bg-primary-transparent border border-primary br-3 pd-5">
                    <?= Html::img($fileNV ? File::getIcon($fileNV->file_type) : '', ['width'=>50]) ?>
                </span>
                <div class="ms-auto mt-1 file-dropdown">
                    ...
                    echo Html::a('<i class="fe fe-edit me-2 float-start"></i>Sửa', 
                            ['/kholuutru/file/update', 'id'=>$fileNV->id],
                            [
        ...
        <div class="card-footer border-top-0">
            <div class="d-flex "id="fileContent3">
                <div>
                    <h5 class="text-primary"><?= $fileNV->file_display_name ?></h5>
                    <p class="text-muted fs-13 mb-0"><?= $fileNV->file_name ?></p>
                </div>
                <div class="ms-auto">
                    <h6 class="fs-11 text-muted"><?= $fileNV->file_size ?></h6>
                    <h6 class="fs-11 text-muted"><?= $fileNV->id ?></h6>
                </div>
            </div>
        </div>
    </div>
