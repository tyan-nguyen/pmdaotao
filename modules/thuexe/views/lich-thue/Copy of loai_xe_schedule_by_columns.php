...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            datesAboveResources: true,   // ngày hiển thị trên resource
              resourceOrder: 'order',      // sắp xếp theo field "order"
              resources: [
                { id: 'col1', title: 'Cột 1', order: 1 },
                { id: 'col2', title: 'Cột 2', order: 2 },
                { id: 'col3', title: 'Cột 3', order: 3 },
                { id: 'col4', title: 'Cột 4', order: 4 },
                { id: 'col5', title: 'Cột 5', order: 5 },
                { id: 'col6', title: 'Cột 6', order: 6 },
              ],
