...
<div class="row text-center" style="width: 100%">
    <div class="col-md-12" style="width: 100%"> 
    	...
    	<table id="table-noi-dung" style="width: 100%">
    		<tr>
    			<td>Họ tên học viên: <?= $model->lichThue->khachHang?$model->lichThue->khachHang->ho_ten:'' ?></td>
    		...
    		<tr>
    			<td colspan="2">Nội dung: Thu tiền thuê xe tập lái biển số <?= $model->lichThue->xe->tenXeShort ?></td>
    		</tr>
    		<tr>
    			<td colspan="2">
        			<span>Số tiền: <?= number_format($model->so_tien, 0, ',', '.') ?> đồng </span>
