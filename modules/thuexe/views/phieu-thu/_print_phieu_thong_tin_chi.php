    ...
    <div class="col-md-12" style="width: 100%"> 
    	...
    	<table id="table-tieu-de" style="width: 100%;margin-top:-10px">
    		<tr>
    			<td></td>
    			<td>
    				<span class="phieu-h1">PHIẾU CHI TIỀN</span>
    	...
    	<table id="table-noi-dung" style="width: 100%; margin-top:5px;font-size:11pt;">
    		...
    		<tr>
    			<td>Địa chỉ: <?= $model->lichThue->khachHang->dia_chi ?></td>
    			<td>SĐT: <?= $model->lichThue->khachHang->so_dien_thoai ?></td>
    		</tr>
    		<tr>
    			<td colspan="2">Nội dung: Chi lại tiền thuê xe tập lái biển số <?= $model->lichThue->xe->tenXeShort ?></td>
    		</tr>
    		<tr>
    			<td colspan="2">
        			<span>Số tiền: <?= number_format(abs($model->so_tien), 0, ',', '.') ?> đồng </span>
