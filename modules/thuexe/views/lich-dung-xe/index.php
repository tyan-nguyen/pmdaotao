...
/* @var $searchModel app\modules\thuexe\models\search\LichDungXeSearch */
    ...
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'panel' => [
                ...
                'heading' => '<i class="typcn typcn-folder-open"></i> DANH SÁCH LỊCH SỬ DỤNG XE',
                'before'=>false,
            ],
            'export'=>[
                'options' => [
