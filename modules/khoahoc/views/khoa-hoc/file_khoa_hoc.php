...
?>
<?php foreach ($fileKhoaHoc as $fileKH){ ?>
    ...
    <div class="card custom-card">
        <div class="card-body p-3">
            <div class="d-flex">
                <span class="bg-primary-transparent border border-primary br-3 pd-5">
                    <?= Html::img($fileKH ? File::getIcon($fileKH->file_type) : '', ['width'=>50]) ?>
                </span>
                <div class="ms-auto mt-1 file-dropdown">
                    ...
                    echo Html::a('<i class="fe fe-edit me-2 float-start"></i>Sửa', 
                            ['/kholuutru/file/update', 'id'=>$fileKH->id],
                            [
        ...
        <div class="card-footer border-top-0">
            <div class="d-flex "id="fileContent3">
                <div>
                    <h5 class="text-primary"><?= $fileKH->file_display_name ?></h5>
                    <p class="text-muted fs-13 mb-0"><?= $fileKH->file_name ?></p>
                </div>
                <div class="ms-auto">
                    <h6 class="fs-11 text-muted"><?= $fileKH->file_size ?></h6>
                    <h6 class="fs-11 text-muted"><?= $fileKH->id ?></h6>
                </div>
            </div>
        </div>
    </div>
