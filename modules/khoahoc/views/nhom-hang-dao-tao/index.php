...
/* @var $searchModel app\modules\khoahoc\models\search\NhomHangDaoTaoSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Nhóm hạng đào tạo';
...
<div class="nhom-hang-dao-tao-index">
    <div id="ajaxCrudDatatable">
        <?= GridView::widget([
            ...
            'panel' => [
                ...
                'heading' => '<i class="typcn typcn-folder-open"></i> DANH SÁCH NHÓM HẠNG',
                'before' => false,
            ],
            'export' => [
                'options' => [
