...
/* @var $searchModel app\modules\taisan\models\search\PhieuDeNghiSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Phiếu đề nghị';
    ...
    <div id="ajaxCrudDatatable">
        <?= GridView::widget([
            ...
            'panel' => [
                ...
                'heading' => '<i class="typcn typcn-folder-open"></i> DANH SÁCH PHIẾU ĐỀ NGHỊ',
                'before' => false,
            ],
            'export' => [
                'options' => [
