...
<div class="tai-san-form">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <?= $form->field($model, 'loai_tai_san_id')->dropDownList(LoaiTaiSan::getList(), ['prompt' => 'Chọn loại...']) ?>
        </div>
        <div class="col-md-4">
            <?= $form->field($model, 'danh_muc_id')->dropDownList(DanhMucTaiSan::getList(), ['prompt' => 'Chọn danh mục...']) ?>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-4">
            <?= $form->field($model, 'nha_cung_cap_id')->textInput() ?>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-4">
            <?= $form->field($model, 'ghi_chu_bao_hanh')->textarea(['rows' => 6]) ?>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-4">
            <?= $form->field($model, 'muc_dich_su_dung')->textarea(['rows' => 6]) ?>
        </div>
        <div class="col-md-4">
