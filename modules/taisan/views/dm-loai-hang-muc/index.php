...
/* @var $searchModel app\modules\taisan\models\search\DmLoaiHangMucSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Danh mục loại hạng mục';
...
<div class="dm-loai-hang-muc-index">
    <div id="ajaxCrudDatatable">
        <?= GridView::widget([
            ...
            'panel' => [
                ...
                'heading' => '<i class="typcn typcn-folder-open"></i> DANH SÁCH',
                'before' => false,
            ],
            'export' => [
                'options' => [
