...
/* @var $searchModel app\modules\taisan\models\search\DmHangMucSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Danh mục hạng mục';
    ...
    <div id="ajaxCrudDatatable">
        <?= GridView::widget([
            ...
            'panel' => [
                ...
                'heading' => '<i class="typcn typcn-folder-open"></i> DANH SÁCH HẠNG MỤC',
                'before' => false,
            ],
            'export' => [
                'options' => [
