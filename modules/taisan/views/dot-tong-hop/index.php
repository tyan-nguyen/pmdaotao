...
/* @var $searchModel app\modules\taisan\models\search\DotTongHopSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Dot Tong Hops';
    ...
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'panel' => [
                ...
                'heading' => '<i class="typcn typcn-folder-open"></i> DANH SÁCH Dot Tong Hops',
                'before'=>false,
            ],
            'export'=>[
                'options' => [
