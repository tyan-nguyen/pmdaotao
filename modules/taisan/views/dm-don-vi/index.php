...
/* @var $searchModel app\modules\taisan\models\search\DmDonViSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Danh mục đơn vị/đối tác';
    ...
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'panel' => [
                ...
                'heading' => '<i class="typcn typcn-folder-open"></i> DANH SÁCH ĐƠN VỊ/ĐỐI TÁC',
                'before'=>false,
            ],
            'export'=>[
                'options' => [
