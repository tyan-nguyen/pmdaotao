...
use app\modules\taisan\models\search\LoaiTaiSanSearch;
...
class LoaiTaiSanController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        if (isset($_POST['search']) && $_POST['search'] != null) {
            ...
            $searchModel = new LoaiTaiSanSearch(); // "reset"
    ...
    /**
     * Delete an existing LoaiTaiSan model.
     * For ajax request will return json object
    ...
    /**
     * Delete multiple existing LoaiTaiSan model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
