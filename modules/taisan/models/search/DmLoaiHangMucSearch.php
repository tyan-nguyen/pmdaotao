...
/**
 * DmLoaiHangMucSearch represents the model behind the search form about `app\modules\taisan\models\DmLoaiHangMuc`.
 */
class DmLoaiHangMucSearch extends DmLoaiHangMuc
{
    /**
     * @inheritdoc
     */
