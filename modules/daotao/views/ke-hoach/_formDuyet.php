	...
	<div class="row">
        <div class="col-md-3">
        	...
        	<?= $form->field($model, 'id_giao_vien')->widget(Select2::classname(), [
            	    'data' => !empty($model->id_giao_vien) ? [
            	        $model->id_giao_vien => GiaoVien::findOne($model->id_giao_vien)->ho_ten
            	    ] : GiaoVien::getList(), 
                    'language' => 'vi',
                   'options' => [
        ...
        <div class="col-md-4">
        	<?= $form->field($model, 'trang_thai_duyet')->dropDownList(KeHoach::getDmTrangThaiDuyet(), [
        	    //'prompt'=>'-Tất cả-'
        	]) ?>  
        </div>
        <!-- <div class="col-md-4">
