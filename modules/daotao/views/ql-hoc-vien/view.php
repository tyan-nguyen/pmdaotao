        ...
        <div class="card custom-card">
            <div class="card-header custom-card-header rounded-bottom-0">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link show active" id="ketquahoc-tab" data-bs-toggle="tab" href="#ketquahoc" role="tab" aria-controls="ketquahoc" aria-selected="false"style="color: blue;"><i class="fa fa-adjust"></i> Thời gian học</a>
                    </li>
                 	<!-- 
                    <li class="nav-item" role="presentation">
                   ...
                   <div class="card-body">
                      <div class="skill-tags">
                        ...
                        <!-- Nội dung hiển thị khi click vào "Học phí" -->
                            ...
                            <div class="tab-pane fade show active" id="ketquahoc" role="tabpanel" aria-labelledby="ketquahoc-tab">
