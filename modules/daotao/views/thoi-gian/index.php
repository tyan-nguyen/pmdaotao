...
/* @var $searchModel app\modules\daotao\models\search\DmThoiGianSearch */
    ...
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'panel' => [
                ...
                'heading' => '<i class="typcn typcn-folder-open"></i> DANH SÁCH GIỜ DẠY',
                'before'=>false,
            ],
            'export'=>[
                'options' => [
