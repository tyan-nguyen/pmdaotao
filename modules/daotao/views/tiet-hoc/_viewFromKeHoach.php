    ...
    <tbody>
     ...
     <tr>
     	...
     	if($model->trang_thai_duyet == KeHoach::TT_NHAP || $model->trang_thai_duyet == KeHoach::TT_CHODUYET ){
     	    echo '<span style="color:blue;cursor:pointer;" data-bs-placement="top" data-bs-toggle="tooltip" data-bs-original-title="'.$tietHoc->hocVien->viewSoGioHocHtml().'">' . $tietHoc->hocVien->ho_ten . '</span>';
     	}else{
