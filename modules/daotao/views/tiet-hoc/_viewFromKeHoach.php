    ...
    <tbody>
     ...
     <tr>
     	...
     	if($model->trang_thai_duyet == KeHoach::TT_NHAP || $model->trang_thai_duyet == KeHoach::TT_CHODUYET ){
     	    echo '<span style="color:blue;cursor:pointer;" data-bs-placement="top" data-bs-toggle="tooltip-primary" title="'.$tietHoc->hocVien->viewSoGioHocHtml().'">' . $tietHoc->hocVien->ho_ten . '</span>';
     	}else{
     	     echo $tietHoc->hocVien->ho_ten;
     	}
     	?>
     		<button class="btn ripple btn-info" data-bs-placement="left" data-bs-toggle="tooltip" type="button" data-bs-original-title="Tooltip on left">Hover me</button>
     	</td>
