...
/* @var $searchModel app\modules\daotao\models\search\TietHocSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Tiet Hocs';
    ...
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'panel' => [
                ...
                'heading' => '<i class="typcn typcn-folder-open"></i> DANH SÁCH Tiet Hocs',
                'before'=>false,
            ],
            'export'=>[
                'options' => [
