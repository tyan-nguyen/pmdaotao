...
/* @var $searchModel app\modules\daotao\models\search\HangMonHocSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Hang Mon Hocs';
    ...
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'panel' => [
                ...
                'heading' => '<i class="typcn typcn-folder-open"></i> DANH SÁCH Hang Mon Hocs',
                'before'=>false,
            ],
            'export'=>[
                'options' => [
