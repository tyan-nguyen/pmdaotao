...
/* @var $searchModel app\modules\demxe\models\search\FileTrichXuatSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'File trích xuất từ camera đếm xe';
...
<div class="file-trich-xuat-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
                    ...
                    <div class="dropdown">
						...
						<div class="dropdown-menu tx-13" style="">
							<h6 class="dropdown-header tx-uppercase tx-11 tx-bold bg-info tx-spacing-1">
								Chọn chức năng</h6>'
                    .
                    Html::a('<i class="fas fa fa-plus" aria-hiddi="true"></i> Thêm mới', ['/file-upload/import?menu=demxe2'],
                        ['data-pjax'=>'0',/* 'role'=>'modal-remote', */'title'=> 'Thêm mới','class'=>'dropdown-item'])
                    .
            ...
            'panel' => [
                ...
                'heading' => '<i class="typcn typcn-folder-open"></i> DANH SÁCH FILE TRÍCH XUẤT',
                'before'=>false,
            ],
            'export'=>[
                'options' => [
