...
/* @var $searchModel app\modules\demxe\models\search\FileTrichXuatContentSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Sự kiện từ file';
...
<div class="file-trich-xuat-content-index">
    <div id="ajaxCrudDatatable">
        <?= GridView::widget([
            ...
            'panel' => [
                ...
                'heading' => '<i class="typcn typcn-folder-open"></i> DANH SÁCH SỰ KIỆN TỪ FILE',
                'before' => false,
            ],
            'export' => [
                'options' => [
