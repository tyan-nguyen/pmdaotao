...
<style>
    ...
    .danger-custom-row td:nth-child(6),
    .danger-custom-row td:nth-child(6) .btn-in-grid {
        color: red !important;
    }

    .warning-custom-row td:nth-child(6),
    .warning-custom-row td:nth-child(6) .btn-in-grid {
        color: orange !important;
    }

    .ok-custom-row td:nth-child(6),
    .ok-custom-row td:nth-child(6) .btn-in-grid {
            ...
            'toolbar' => [
                [
                    ...
                    <div class="dropdown">
                        ...
                        . Html::a(
                            '<i class="fas fa-clipboard-list"></i> Báo cáo vi phạm',
                            ['bc-vi-pham'],
