...
<div class="dem-xe-search">
	...
	<div class="row">
<div class="col-md-4">    <?= $form->field($model, 'id_xe')->textInput() ?>

</div><div class="col-md-4">    <?= $form->field($model, 'ma_xe')->textInput(['maxlength' => true]) ?>

</div><div class="col-md-4">    <?= $form->field($model, 'ma_cong')->textInput(['maxlength' => true]) ?>
...
</div><div class="col-md-4">    <?= $form->field($model, 'so_phut')->textInput(['maxlength' => true]) ?>
...
</div><div class="col-md-4">    <?= $form->field($model, 'id_file')->textInput() ?>
