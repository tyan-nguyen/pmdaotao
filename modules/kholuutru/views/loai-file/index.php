    ...
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
                    ...
                    <div class="dropdown">
						...
						<div class="dropdown-menu tx-13" style="">
							<h6 class="dropdown-header tx-uppercase tx-11 tx-bold bg-info tx-spacing-1">
								Chọn chức năng</h6>'
                    .
                    Html::a('<i class="fas fa fa-plus" aria-hiddi="true"></i> Thêm mới', ['create','doiTuong'=>$doiTuong],
            ...
            'panel' => [
                ...
                'heading' => '<i class="typcn typcn-folder-open"></i> DANH SÁCH LOẠI HỒ SƠ',
                'before'=>false,
            ],
            'export'=>[
                'options' => [
