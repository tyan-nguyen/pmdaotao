...
use app\modules\kholuutru\models\search\LoaiFileSearch;
...
/**
 * LoaiFileController implements the CRUD actions for LoaiFile model.
 */
class LoaiFileController extends Controller
{
    ...
    /**
     * Displays a single LoaiFile model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing LoaiFile model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing LoaiFile model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing LoaiFile model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the LoaiFile model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return LoaiFile the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = LoaiFile::findOne($id)) !== null) {
            return $model;
        } else {
            throw new NotFoundHttpException('The requested page does not exist.');
        }
