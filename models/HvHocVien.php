...
class HvHocVien extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['ngay_het_han_cccd', 'thoi_gian_tao', 'ngay_sinh', 'thoi_gian_hoan_thanh_ho_so', 'ngay_nhan_ao', 'ngay_nhan_tai_lieu', 'thoi_gian_huy_ho_so', 'ngay_lien_ket','ngay_nhap_ho_so_ho'], 'safe'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'id_nhan_ho_so_ho' => 'Id Nhan Ho So Ho',
            'id_nguoi_nhap_nhan_ho_so_ho' => 'Id Nguoi Nhap Nhan Ho So Ho',
