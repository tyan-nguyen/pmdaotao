...
class FileDisplayImagesWidget extends Widget
{
    public $doiTuong;
    public $idDoiTuong;
    ...
    public function run()
    {
        $files = File::getAllByDoiTuongAndImages($this->doiTuong, $this->idDoiTuong);
        if ($files) {
            return $this->render('@app/widgets/views/files/by_image', [
                'files' => $files,
            ]);
        } else {
