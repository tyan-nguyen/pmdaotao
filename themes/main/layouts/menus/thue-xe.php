				...
				<div class="tab-content">
					<div class="tab-pane active" id="side3">
						<ul class="sidemenu-list">
							...
							<li class=""><a href="<?= Yii::getAlias('@web/thuexe/lich-thue?menu=dc6') ?>" class="slide-item" data-menu="dc6"><i class="fe fe-file-text"></i> Lịch thuê xe</a></li>
							...
							<li class=""><a href="<?= Yii::getAlias('@web/thuexe/xe?menu=dc1') ?>" class="slide-item" data-menu="dc1"><i class="fe fe-file-text"></i> Danh sách Xe</a></li>
