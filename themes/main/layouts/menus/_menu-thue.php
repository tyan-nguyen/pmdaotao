			...
			<div class="panel-body tabs-menu-body p-0 border-0">
				<div class="tab-content">
					<div class="tab-pane active" id="side3">
						<ul class="sidemenu-list">
							<li class="side-menu__label1"><a href="javascript:void(0)">Danh mục chức năng</a></li>
							<li><a href="/thuexe/phieu-thu/phieu-thu?menu=tx1" class="slide-item" data-menu="tx1"> <i class="fe fe-file-text"></i> Phiếu thu</a></li>
							<li><a href="/thuexe/phieu-thu/phieu-thu?menu=tx2" class="slide-item" data-menu="tx2"> <i class="fe fe-file-text"></i> Phiếu chi</a></li>
...
<li class="slide">
	<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
		<!-- <span class="side-menu__icon"><i class="fe fe-users side_menu_img"></i></span>
		<span class="side-menu__label">Quản lý giáo viên</span><i class="angle fe fe-chevron-right"></i> -->
		<span class="side-menu__label"><i class="fa fa-folder"></i> Thông tin xe</span><i class="angle fa fa-caret-right"></i>
	</a>
	<ul class="slide-menu" data-menu="xe">
		<li class="panel sidetab-menu">
			<div class="tab-menu-heading p-0 pb-2 border-0">
				<div class="tabs-menu ">
					<ul class="nav panel-tabs">
