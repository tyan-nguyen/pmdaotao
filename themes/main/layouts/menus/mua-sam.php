<li class="slide">
    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);">
        ...
        <span class="side-menu__label"><i class="fa fa-folder"></i> MUA HÀNG</span><i class="angle fa fa-caret-right"></i>
    </a>
    <ul class="slide-menu" data-menu="muasam">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="side7">
                        <ul class="sidemenu-list">
                            ...
                            <li class=""><a href="<?= Yii::getAlias('@web/taisan/phieu-mua-sam/index?menu=muasam1') ?>" class="slide-item" data-menu="muasam1"><i class="fe fe-file-text"></i> Phiếu đề nghị mua mới</a>
                            </li>
