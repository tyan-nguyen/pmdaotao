				...
				<div class="tab-content">
					<div class="tab-pane active" id="side5">
						<ul class="sidemenu-list">
							...
							<li><a href="<?= Yii::getAlias('@web/giaovien/giao-vien?menu=gv1') ?>" class="slide-item" data-menu="gv1">Quản lý giáo viên</a>
							</li>
							<li><a href="/kholuutru/loai-file/index?doiTuong=<?= GiaoVien::MODEL_ID ?>&menu=gv2" class="slide-item" data-menu="gv2">Loại hồ sơ</a></li>
